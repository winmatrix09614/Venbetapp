...
export const THEMES = {
  ...
  default: {
    ...
    ui: {
      ...
      verdictTag: 'ВЕРДИКТ НЕЙРОСЕТИ', confidence: 'Уверенность', baseConf: 'Базовая оценка', promoTitle: 'Сделай свой AI-прогноз', promoSub: 'Узнай, кто победит — за секунды', promoBtn: 'Начать',
  ...
  es: {
    ...
    ui: {
      ...
      verdictTag: 'VEREDICTO DE LA IA', confidence: 'Confianza', baseConf: 'Evaluación base', promoTitle: 'Haz tu pronóstico con IA', promoSub: 'Descubre quién gana en segundos', promoBtn: 'Empezar',
  ...
  pt: {
    ...
    ui: {
      ...
      verdictTag: 'VEREDITO DA IA', confidence: 'Confiança', baseConf: 'Avaliação base', promoTitle: 'Faça seu palpite com IA', promoSub: 'Descubra quem vence em segundos', promoBtn: 'Começar',
  ...
  fr: {
    ...
    ui: {
      ...
      verdictTag: 'VERDICT DE L’IA', confidence: 'Confiance', baseConf: 'Évaluation de base', promoTitle: 'Fais ton pronostic IA', promoSub: 'Découvre qui gagne en quelques secondes', promoBtn: 'Commencer',
  ...
  tr: {
    ...
    ui: {
      ...
      verdictTag: 'YAPAY ZEKÂ KARARI', confidence: 'Güven', baseConf: 'Temel değerlendirme', promoTitle: 'Yapay zekâ tahminini yap', promoSub: 'Kim kazanır saniyeler içinde öğren', promoBtn: 'Başla',
  ...
  az: {
    ...
    ui: {
      ...
      verdictTag: 'SÜNİ İNTELLEKT QƏRARI', confidence: 'Əminlik', baseConf: 'Baza qiymət', promoTitle: 'AI proqnozunu et', promoSub: 'Kimin qazanacağını saniyələrdə öyrən', promoBtn: 'Başla',
  ...
  en: {
    ...
    ui: {
      ...
      verdictTag: 'AI VERDICT', confidence: 'Confidence', baseConf: 'Base estimate', promoTitle: 'Make your AI prediction', promoSub: 'Find out who wins in seconds', promoBtn: 'Start',
