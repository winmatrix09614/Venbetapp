...
export const THEMES = {
  ...
  default: {
    ...
    ui: {
      ...
      verdictTag: 'ВЕРДИКТ НЕЙРОСЕТИ', confidence: 'Уверенность', baseConf: 'Базовая оценка', promoTitle: 'Сделай свой AI-прогноз', promoSub: 'Узнай, кто победит — за секунды', promoBtn: 'Начать', hiwTitle: 'Как это работает', hiwStep1: 'Введи 1xBet ID', hiwStep2: 'AI анализирует', hiwStep3: 'Ставишь увереннее', tickerTitle: 'Последние прогнозы AI',
  ...
  pt: {
    ...
    ui: {
      ...
      verdictTag: 'VEREDITO DA IA', confidence: 'Confiança', baseConf: 'Avaliação base', promoTitle: 'Faça seu palpite com IA', promoSub: 'Descubra quem vence em segundos', promoBtn: 'Começar', hiwTitle: 'Como funciona', hiwStep1: 'Insira seu 1xBet ID', hiwStep2: 'A IA analisa', hiwStep3: 'Aposta com confiança', tickerTitle: 'Últimos palpites IA',
  ...
  tr: {
    ...
    ui: {
      ...
      verdictTag: 'YAPAY ZEKÂ KARARI', confidence: 'Güven', baseConf: 'Temel değerlendirme', promoTitle: 'Yapay zekâ tahminini yap', promoSub: 'Kim kazanır saniyeler içinde öğren', promoBtn: 'Başla', hiwTitle: 'Nasıl çalışır', hiwStep1: '1xBet ID gir', hiwStep2: 'AI analiz eder', hiwStep3: 'Güvenle bahis yap', tickerTitle: 'Son AI tahminleri',
  ...
  az: {
    ...
    ui: {
      ...
      verdictTag: 'SÜNİ İNTELLEKT QƏRARI', confidence: 'Əminlik', baseConf: 'Baza qiymət', promoTitle: 'AI proqnozunu et', promoSub: 'Kimin qazanacağını saniyələrdə öyrən', promoBtn: 'Başla', hiwTitle: 'Necə işləyir', hiwStep1: '1xBet ID daxil et', hiwStep2: 'AI təhlil edir', hiwStep3: 'Əminliklə mərc et', tickerTitle: 'Son AI proqnozları',
  ...
  en: {
    ...
    ui: {
      ...
      verdictTag: 'AI VERDICT', confidence: 'Confidence', baseConf: 'Base estimate', promoTitle: 'Make your AI prediction', promoSub: 'Find out who wins in seconds', promoBtn: 'Start', hiwTitle: 'How it works', hiwStep1: 'Enter 1xBet ID', hiwStep2: 'AI analyzes', hiwStep3: 'Bet with confidence', tickerTitle: 'Latest AI predictions',
