...
export const THEMES = {
  ...
  default: {
    ...
    ui: {
      ...
      verdictTag: 'ВЕРДИКТ НЕЙРОСЕТИ', confidence: 'Уверенность', baseConf: 'Базовая оценка',
  ...
  es: {
    ...
    ui: {
      ...
      verdictTag: 'VEREDICTO DE LA IA', confidence: 'Confianza', baseConf: 'Evaluación base',
  ...
  pt: {
    ...
    ui: {
      ...
      verdictTag: 'VEREDITO DA IA', confidence: 'Confiança', baseConf: 'Avaliação base',
  ...
  fr: {
    ...
    ui: {
      ...
      verdictTag: 'VERDICT DE L’IA', confidence: 'Confiance', baseConf: 'Évaluation de base',
  ...
  tr: {
    ...
    ui: {
      ...
      verdictTag: 'YAPAY ZEKÂ KARARI', confidence: 'Güven', baseConf: 'Temel değerlendirme',
  ...
  az: {
    ...
    ui: {
      ...
      verdictTag: 'SÜNİ İNTELLEKT QƏRARI', confidence: 'Əminlik', baseConf: 'Baza qiymət',
